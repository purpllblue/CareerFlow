...
if (isset($_POST['save'])) {
    ...
    (nama_perusahaan, industri, lokasi, website, catatan)
    VALUES
    ('$nama_perusahaan', '$industri', '$lokasi', '$website', '$catatan')"
);
...
<head>
    ...
    <title>Add Company - CareerFlow</title>
...
<div class="main">
    ...
    <div class="main-card">
        ...
        <div class="card-header-custom">
            ...
            <p>
                Add the details of a company you're interested in.
            </p>
            ...
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        class="form-control"
                        rows="5"
                        placeholder="Add any useful information about this company..."
                    ></textarea>
